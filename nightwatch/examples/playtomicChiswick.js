...
describe('playtomic example', function () {
	it('Search Nightwatch.js and check results', (browser) => {
		browser
			.navigateTo(`https://playtomic.io/rocks-lane-chiswick/9c95ac87-5273-47a9-bf67-342c566caf79?q=PADEL~${day.format("YYYY-MM-DD")}~~~`)
			...
			.execute(() => {
				...
				fs.appendFileSync(path.join(__dirname , '../../data/playtomic_chiswick.tsv'), csv);
			});
	});
});